...
class EscalaLimpezaWidget extends StatefulWidget {
  const EscalaLimpezaWidget({Key key}) : super(key: key);

  @override
  _EscalaLimpezaWidgetState createState() => _EscalaLimpezaWidgetState();
}

class _EscalaLimpezaWidgetState extends State<EscalaLimpezaWidget> {
                      ...
                      child: Padding(
                        ...
                        child: StreamBuilder<List<EscalaLimpezaRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<EscalaLimpezaRecord>
                                listViewEscalaLimpezaRecordList = snapshot.data;
                            return ListView.builder(
                              padding: EdgeInsets.zero,
                              primary: false,
                              scrollDirection: Axis.vertical,
                              itemCount: listViewEscalaLimpezaRecordList.length,
                              itemBuilder: (context, listViewIndex) {
                                final listViewEscalaLimpezaRecord =
                                    listViewEscalaLimpezaRecordList[
                                        listViewIndex];
                                return Padding(
                            ...
                            child: FutureBuilder<List<EscalaLimpezaRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return ListView.builder(
                                  ...
                                  scrollDirection: Axis.vertical,
                                  itemCount:
                                      listViewEscalaLimpezaRecordList.length,
                                  itemBuilder: (context, listViewIndex) {
                                    final listViewEscalaLimpezaRecord =
                                        listViewEscalaLimpezaRecordList[
                                            listViewIndex];
