...
class EscalaPastoralWidget extends StatefulWidget {
  const EscalaPastoralWidget({Key key}) : super(key: key);

  @override
  _EscalaPastoralWidgetState createState() => _EscalaPastoralWidgetState();
}

class _EscalaPastoralWidgetState extends State<EscalaPastoralWidget> {
                ...
                children: [
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: FutureBuilder<List<EscalaPastoralRecord>>(
                        future: queryEscalaPastoralRecordOnce(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<EscalaPastoralRecord>
                              listViewEscalaPastoralRecordList = snapshot.data;
                          return ListView.builder(
                            padding: EdgeInsets.zero,
                            primary: false,
                            scrollDirection: Axis.vertical,
                            itemCount: listViewEscalaPastoralRecordList.length,
                            itemBuilder: (context, listViewIndex) {
                              final listViewEscalaPastoralRecord =
                                  listViewEscalaPastoralRecordList[
                                      listViewIndex];
                              return Padding(
                                padding:
                          ...
                          child: FutureBuilder<List<EscalaPastoralRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return ListView.builder(
                                ...
                                scrollDirection: Axis.vertical,
                                itemCount:
                                    listViewEscalaPastoralRecordList.length,
                                itemBuilder: (context, listViewIndex) {
                                  final listViewEscalaPastoralRecord =
                                      listViewEscalaPastoralRecordList[
                                          listViewIndex];
